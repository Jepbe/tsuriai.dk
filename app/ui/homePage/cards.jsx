...
export default function Cards() {
    return (
        <div className="
            ...
            mt-10
        ">
            <div className="bg-white w-[350px] sm:w-[380px] rounded-lg h-[60vh] sm:h-[74vh] drop-shadow-sm">
                ...
                <div className='grid place-items-center relative bottom-24 sm:bottom-10'>
                    ...
                    <p className='text-center text-md'>Ju Jitsu er de gamle japanske samuraiers kampkunst. Samuraiernes kampkunst blev udviklet for at kunne nedkæmpe en fjende iført rustning </p> <br />
                    <button className='border-gray-400 border-[1px] rounded-md px-2 py-1 hover:bg-gray-400/[.2]'>Læs mere</button>
                </div>
            </div>

            <div className="bg-white w-[350px] sm:w-[380px] rounded-lg h-[60vh] sm:h-[74vh] drop-shadow-sm grid place-items-center">
